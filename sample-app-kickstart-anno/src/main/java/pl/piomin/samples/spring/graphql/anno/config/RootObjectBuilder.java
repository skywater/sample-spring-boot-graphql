...
package pl.piomin.samples.spring.graphql.anno.config;
...
import pl.piomin.samples.spring.graphql.anno.resolver.MutationResolver;
import pl.piomin.samples.spring.graphql.anno.resolver.QueryResolver;
...
public class RootObjectBuilder extends OncePerRequestFilter implements GraphQLServletRootObjectBuilder {
	...
	private final MutationResolver mutable;
